#!/bin/bash
#SBATCH --job-name=tmaze_zero_pad
#SBATCH --output=out/tmaze_zero_pad_%A_%a.out
#SBATCH --error=err/tmaze_zero_pad_%A_%a.err
#SBATCH --array=0-9
#SBATCH --time=1:59:59
#SBATCH --mem=10G
...
pip install --no-index matplotlib # needed for TMaze
